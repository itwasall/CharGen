...
MONOFILAMENT_CHAINSAW = MeleeWeapon("Monofilament Chainsaw", cost=500, page_ref=448, rating=1, avail=8, subtype="Exotic Melee Weapon")
...
DETONATOR_CAP = Item("Detonator Cap", cost=75, page_ref=436, rating=1, avail=8, legality=RESTRICTED, category="Explosives")
...
DATA_TAP = Electronics("Data Tap", cost=300, page_ref=441, rating=1, avail=6, legality=RESTRICTED, subtype="Communications")
...
CYBERPROGRAM_HACKING = Electronics("Cyberprogram Hacking", cost=250, page_ref=442, rating=1, avail=6, legality=RESTRICTED, subtype="Software")
...
MAGE_SIGHT_GOGGLES = Electronics("Mage Sight Goggles", cost=3000, page_ref=444, rating=1, avail=12, legality=RESTRICTED, subtype="Optical/Imaging Devices")
MONOCLE = Electronics("Monocle", cost=3000, page_ref=444, rating=1, avail=12, legality=RESTRICTED, capacity=[1, "to", 3], subtype="Optical/Imaging Devices")
# =============== VISION ENCHANCEMENTS 
LOW_LIGHT_VISION_ENC = Electronics("Low-Light Vision", cost=500, page_ref=444, rating=1, avail=4, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
FLARE_COMPENSATION_ENC = Electronics("Flare Compensation", cost=250, page_ref=444, rating=1, avail=1, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
IMAGE_LINK_ENC = Electronics("Image Link", cost=25, page_ref=444, rating=1, avail=0, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
SMARTLINK_ENC = Electronics("Smartlink", cost=2000, page_ref=444, rating=1, avail=4, legality=RESTRICTED, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
THERMOGRAPHIC_VISION_ENC = Electronics("Thermographic Vision", cost=500, page_ref=444, rating=1, avail=6, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
VISION_ENHANCEMENT_ENC = Electronics("Vision Enhancement", cost=["Rating", "*", 500], page_ref=444, rating=1, avail=["Rating", "*", 2], capacity="Rating", subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
VISION_MAGNIFICATION_ENC = Electronics("Vision Magnification", cost=250, page_ref=444, rating=1, avail=2, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
# =============== AUDIO DEVICES=======
...
LASER_MIC = Electronics("Laser Mic", cost=["Capacity", "*", 100], page_ref=445, rating=1, avail=6, legality=RESTRICTED, capacity=[1, "to", 6], subtype="Audio Device")
...
CONTAINMENT_MANACLES = Electronics("Containment Manacles", cost=250, page_ref=447, rating=1, avail=6, legality=RESTRICTED, subtype="Restraint")
...
LOCKPICK_SET = Electronics("Lockpick Set", cost=250, page_ref=448, rating=1, avail=4, legality=RESTRICTED, subtype="B&E Gear")
...
# GRAPPLE GUN
GRAPPLE_GUN = Item("Grapple Gun", cost=500, page_ref=450, rating=1, avail=8, legality=RESTRICTED, category="Grapple Gun")
CATALYST_STICK = Item("Catalyst Stick", cost=120, page_ref=450, rating=1, avail=8, legality=FORBIDDEN, category="Grapple Gun")
...
STEALTH_ROPE = Item("Stealth Rope (100m)", cost=85, page_ref=450, rating=1, avail=8, legality=FORBIDDEN, category="Grapple Gun")
# BIOTECH
...
YAMAHA_NODACHI = Vehicle('Yamaha Nodachi', cost=28000, avail=12, legality=RESTRICTED, page_ref="R5.0, 185", subtype="Bike", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
# TRACTOR
MACK_HELLHOUND = Vehicle("mack Hellhound", cost=150_000, avail=16, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Tractor", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
# BUS
...
UNIVERSAL_HOVERCRAFT_MINNESOTA = Vehicle("universal Hovercraft Minnesota", cost=130_000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Hovercraft", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
VODYANOV_ASSAULT_HOVERCRAFT = Vehicle("vodyanov Assault Hovercraft", cost=84000, avail=12, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Hovercraft", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
# CORPSEC / POLICE / MILITARY
BMW_BLITZKRIEG = Vehicle("bmw Blitzkrieg", cost=46000, avail=14, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
DODGE_CHARGER = Vehicle("dodge Charger", cost=65000, avail=16, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
DODGE_GENERAL = Vehicle("dodge General", cost=344_000, avail=18, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
DODGE_GOLIATH = Vehicle("dodge Goliath", cost=120_000, avail=20, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
BMW_I8_INTERCEPTOR = Vehicle("bmw I8 Interceptor", cost=114_000, avail=16, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
BMW_LUXUS = Vehicle("bmw Luxus", cost=398_000, avail=14, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
DODGE_RHINO = Vehicle("dodge Rhino", cost=225_000, avail=18, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
DODGE_STALLION = Vehicle("dodge Stallion", cost=78000, avail=16, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
BMW_STURMWAGON = Vehicle("bmw Sturmwagon", cost=145_000, avail=20, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
BMW_TEUFELKATZE = Vehicle("bmw Teufelkatze", cost=76000, avail=16, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
RUHMETALL_WOLF_II = Vehicle("ruhmetall Wolf Ii", cost=330_000, avail=20, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Corpsec/Police/Military", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
GMC_RIVERINE_MILITARY = Vehicle("Gmc Riverine Military", cost=225000, avail=20, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Sailcraft", skill_req=PILOT_WATERCRAFT, rulebook="Rigger 5.0")
GMC_RIVERINE_POLICE = Vehicle("Gmc Riverine_police", cost=154000, avail=15, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Sailcraft", skill_req=PILOT_WATERCRAFT, rulebook="Rigger 5.0")
GMC_RIVERINE_SECURITY = Vehicle("Gmc Riverine Security", cost=100000, avail=15, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Sailcraft", skill_req=PILOT_WATERCRAFT, rulebook="Rigger 5.0")
...
AZTECHNOLOGY_AGULAR_GX_2 = Vehicle("Aztechnology Agular Gx 2", cost=500_000, avail=28, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Rotocraft", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
AZTECHNOLOGY_AGULAR_GX_3AT = Vehicle("Aztechnology Agular Gx 3at", cost=550_000, avail=28, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Rotocraft", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
S_K_AEROSPACE_SKA_008 = Vehicle("S K Aerospace Ska 008", cost=525_000, avail=24, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Rotocraft", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
DASSAULT_SEA_SPRITE = Vehicle("Dassault Sea Sprite", cost=400_000, avail=18, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Rotocraft", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
# FIXED WING
...
# VTOL
GMC_GRYPHON = Vehicle("Gmc Gryphon", cost=3200000, avail=28, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="VTOL", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
EVO_KRIME_KRIME_WING = Vehicle("Evo Krime Krime Wing", cost=2275000, avail=24, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="VTOL", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
# LTA VEHICLE
...
RENEGADE_WORKS_MOTHERSHIP_LAVH = Vehicle("Renegade Works Mothership Lavh", cost=50000, avail=24, legality=RESTRICTED, page_ref="R5.0, 186", subtype="LTA", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")

# MICRODRONES
HORIZON_NOIZTQUITO = Vehicle("Horizon Noiztquito", cost=2000, avail=10, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Microdrone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
...
# MINI DRONES
AERSODESIGN_SYSTEMS_CONDOR_LOSD_23 = Vehicle("Aersodesign Systems Condor Losd 23", cost=4000, avail=6, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Mini Drone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
AZTECHNOLOGY_HEDGEHOG = Vehicle("Aztechnology Hedgehog", cost=8000, avail=8, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Mini Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
CYBERSPACE_DESIGNS_DRAGONFLY = Vehicle("Cyberspace Designs Dragonfly", cost=4000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Mini Drone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
...
# SMALL DRONES
ARES_ARMS_SENTRY_V = Vehicle("Ares Arms Sentry V", cost=4000, avail=4, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
FERRET_PRD_1X_WHEELED_PERIMETER_DRONE = Vehicle("Ferret Prd 1x Wheeled Perimeter Drone", cost=4000, avail=8, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
KNIGHT_ERRANT_PS_PERSUIT_DRONE = Vehicle("Knight Errant Ps Persuit Drone", cost=8000, avail=10, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
LONG_STAR_CASTLE_GUARD = Vehicle("Long Star Castle Guard", cost=10_000, avail=8, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
MITSUHAMA_GUN_TURRET = Vehicle("Mitsuhama Gun Turret", cost=4000, avail=4, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Small Drone", skill_req=None, rulebook="Rigger 5.0")
...
NEONET_PRAIRIE_DOG = Vehicle("Neonet Prairie Dog", cost=8000, avail=12, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
PROTEUS_AG_KRAKE = Vehicle("Proteus Ag Krake", cost=10000, avail=18, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Small Drone", skill_req=PILOT_WATERCRAFT, rulebook="Rigger 5.0")
...
# MEDIUM DRONES
ARES_CHEETAH = Vehicle("Ares Cheetah", cost=14000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Medium Drone", skill_req=PILOT_WALKER, rulebook="Rigger 5.0")
EVO_KROKODIL = Vehicle("Evo Krokodil", cost=12000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Medium Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
MCT_TUNNELER = Vehicle("Mct Tunneler", cost=10000, avail=8, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Medium Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
RENRAKU_LEBD_2 = Vehicle("Renraku Lebd 2", cost=20000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Medium Drone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
...
# LARGE DRONES
ARES_MATILDA = Vehicle("Ares Matilda", cost=18000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Large Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
ARES_PALADIN = Vehicle("Ares Paladin", cost=5000, avail=8, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Large Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
...
SAEDER_KRUPP_MK_7D_NEPTUNE = Vehicle("Saeder Krupp Mk 7d Neptune", cost=17500, avail=10, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Large Drone", skill_req=PILOT_WATERCRAFT, rulebook="Rigger 5.0")
MITSUHAMA_MALAKIM = Vehicle("Mitsuhama Malakim", cost=40000, avail=20, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Large Drone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
# HUGE DRONES
ARES_KN_YO_DEIMOS = Vehicle("Ares Kn Yo Deimos", cost=220_000, avail=20, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Huge Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
ARES_KN_YO_ERIS = Vehicle("Ares Kn Yo Eris", cost=270_000, avail=24, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Huge Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
ARES_KN_YO_PHOBOS = Vehicle("Ares Kn Yo Phobos", cost=250_000, avail=16, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Huge Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
MESAMETRIC_KODIAK = Vehicle("Mesametric Kodiak", cost=40000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Huge Drone", skill_req=PILOT_GROUND_CRAFT, rulebook="Rigger 5.0")
NEONET_AVENGING_ANGEL = Vehicle("Neonet Avenging Angel", cost=1_000_000, avail=40, legality=FORBIDDEN, page_ref="R5.0, 186", subtype="Huge Drone", skill_req=PILOT_AIRCRAFT, rulebook="Rigger 5.0")
...
MITSUHAMA_KENCHIKU_KIKAI = Vehicle("Mitsuhama Kenchiku Kikai", cost=20000, avail=8, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Anthropomorphic Drone", skill_req=None, rulebook="Rigger 5.0")
NEONET_JUGGERNAUGHT = Vehicle("Neonet Juggernaught", cost=100_000, avail=14, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Anthropomorphic Drone", skill_req=None, rulebook="Rigger 5.0")
SAEDER_KRUPP_DIREKTIONSSEKRETAR = Vehicle("Saeder Krupp Direktionssekretar", cost=40000, avail=12, legality=RESTRICTED, page_ref="R5.0, 186", subtype="Anthropomorphic Drone", skill_req=None, rulebook="Rigger 5.0")
...
LIMINAL_BODY_TANK = AugmentationCore("Liminal_body_tank", page_ref="CF, 223", cost=50000, essence=3, capacity=60, avail=12, legality=RESTRICTED, subtype='Cyberlimbs', location="Full Leg", mods=[], rulebook='Chrome Flesh')
...
FALSE_FACE = Augmentation("False Face", page_ref='CF, 223', cost=20000, essence=0.5, capacity=8, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Headware", rulebook='Chrome Flesh')
...
VOICE_MASK = Augmentation("Voice_mask", page_ref='CF, 223', cost=2000, essence=0.1, capacity="-", avail=8, legality=FORBIDDEN, subtype="Headware", rulebook='Chrome Flesh')
# EYEWARE
...
AUTO_INJECTOR_KILLSWITCH = Augmentation("Auto_injector_killswitch", page_ref='CF, 223', cost=["Contents", "+", 750], essence=0.05, capacity="-", avail=8, legality=FORBIDDEN, subtype='Bodyware', rulebook='Chrome Flesh')
...
MOVE_BY_WIRE_RATING_1 = Augmentation("Move_by_wire_rating_1", page_ref='CF, 223', cost=40000, essence=3, capacity="-", avail=12, legality=FORBIDDEN, subtype='Bodyware', rulebook='Chrome Flesh')
MOVE_BY_WIRE_RATING_2 = Augmentation("Move_by_wire_rating_2", page_ref='CF, 223', cost=125_000, essence=4, capacity="-", avail=18, legality=FORBIDDEN, subtype='Bodyware', rulebook='Chrome Flesh')
MOVE_BY_WIRE_RATING_3 = Augmentation("Move_by_wire_rating_3", page_ref='CF, 223', cost=205_000, essence=5, capacity="-", avail=24, legality=FORBIDDEN, subtype='Bodyware', rulebook='Chrome Flesh')
...
SKIN_TONER_CHARMELEON_PROCESSOR = Augmentation("Skin_toner_charmeleon_processor", page_ref='CF, 223', cost=8000, essence=.3, capacity=2, avail=12, legality=FORBIDDEN, subtype='Bodyware', rulebook='Chrome Flesh')
...
RAPTOR_FOOT = Augmentation("Raptor_foot", page_ref="CF, 223", cost=8000, essence=.5, capacity=4, avail=8, legality=RESTRICTED, subtype='CylimbAcc', rulebook='Chrome Flesh')
...
# BIOWARE
AMPLIFIED_IMMUNE_SYSTEM_1_4 = Augmentation("Amplified_immune_system_1_4", page_ref='CF, 229', cost=["Rating", "*", 4000], essence=["Rating", "*", 0.1], avail=["Rating", "*", 6], legality=FORBIDDEN, subtype='Bioware', rulebook='Chrome Flesh')
CHEMICAL_GLAND = Augmentation("Chemical_gland", page_ref='CF, 229', cost=["Chemical", "+", 20000], essence=.1, avail=["Rating", "*", 12], legality=RESTRICTED, subtype='Bioware', rulebook='Chrome Flesh')
CHEMICAL_GLAND_EXHALATION_SPRAY = Augmentation("Chemical_gland_exhalation_spray", page_ref='CF, 229', cost=6000, essence=.1, avail=12, legality=RESTRICTED, subtype='Bioware', rulebook='Chrome Flesh')
CHEMICAL_GLAND_SPIT = Augmentation("Chemical_gland_spit", page_ref='CF, 229', cost=6000, essence=.1, avail=12, legality=RESTRICTED, subtype='Bioware', rulebook='Chrome Flesh')
CHEMICAL_GLAND_WEAPON_RESERVOIR = Augmentation("Chemical_gland_weapon_reservoir", page_ref='CF, 229', cost=4000, essence=.1, avail=12, legality=RESTRICTED, subtype='Bioware', rulebook='Chrome Flesh')
...
ORTHOSKIN_CHEMICAL_REPULSION = Augmentation("Orthoskin_chemical_repulsion", page_ref='CF, 229', cost=20000, essence=.25, avail=12, legality=RESTRICTED, subtype='Bioware', rulebook='Chrome Flesh')
...
FLASHBACK_SYSTEM = Augmentation("Flashback_system", page_ref='CF, 153', cost=6000, essence=0.3, avail=8, legality=RESTRICTED, subtype='NanoCybernetics', rulebook='Chrome Flesh')
