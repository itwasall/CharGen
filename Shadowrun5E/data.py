...
SMARTLINK_ENC = Electronics("Smartlink", cost=2000, page_ref=444, rating=1, avail=4, legality=R, capacity=1, subtype="Vision Enhancement", requires=["Subtype", "Optical/Imaging Devices"])
