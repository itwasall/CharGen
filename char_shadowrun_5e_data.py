...
"""
# HEADWARE
COMMLINK = Augmentation("COMMLINK", page_ref=453, cost=["Commlink Cost", "+", 2000], essence=0.2, capacity=2, avail=0, cyberlimbs=True, subtype="Headware", grade=None)
CONTROL_RIG_1 = Augmentation("CONTROL_RIG_1", page_ref=453, cost=43_000, rating=1, essence=1, capacity="-", avail=5, legality=RESTRICTED, subtype="Headware", grade=None)
CONTROL_RIG_2 = Augmentation("CONTROL_RIG_2", page_ref=453, cost=97_000, rating=2, essence=2, capacity="-", avail=10, legality=RESTRICTED, subtype="Headware", grade=None)
CONTROL_RIG_3 = Augmentation("CONTROL_RIG_3", page_ref=453, cost=208_000, rating=3, essence=3, capacity="-", avail=15, legality=RESTRICTED, subtype="Headware", grade=None)
CORTEX_BOMB_KINK = Augmentation("CORTEX_BOMB_KINK", page_ref=453, cost=10_000, essence=0, capacity=1, avail=12, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
CORTEX_BOMB_MICROBOMB = Augmentation("CORTEX_BOMB_MICROBOMB", page_ref=453, cost=25_000, essence=0, capacity=2, avail=16, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
CORTEX_BOMB_AREA = Augmentation("CORTEX_BOMB_AREA", page_ref=453, cost=40_000, essence=0, capacity=3, avail=20, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
...
DATA_LOCK_1_12 = Augmentation("DATA_LOCK_1_12", page_ref=453, cost=["Rating", "*", 1000], rating=[1, "to", 12], essence=0.1, capacity="-", avail=["Rating", "*", 2], subtype="Headware", grade=None)
OLFACTORY_BOOSTER_1_6 = Augmentation("OLFACTORY_BOOSTER_1_6", page_ref=453, cost=["Rating", "*", 4000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=["Rating", "*", 3], subtype="Headware", grade=None)
SIMRIG = Augmentation("SIMRIG", cost=4000, essence=0.2, capacity="-", avail=12, legality=RESTRICTED, subtype="Headware", grade=None)
SKILLJACK_1_6 = Augmentation("SKILLJACK_1_6", page_ref=453, cost=["Rating", "*", 20000], rating=[1, "to", 6], essence=["Rating", "*", 0.1], capacity="-", avail=["Rating", "*", 2], subtype="Headware", grade=None)
TASTE_BOOSTER = Augmentation("TASTE_BOOSTER", page_ref=453, cost=["Rating", "*", 3000], rating=[1, "to", 3], essence=0.2, capacity="-", avail=["Rating", "*", 3], subtype="Headware", grade=None)
TOOTH_COMPARTMENT = Augmentation("TOOTH_COMPARTMENT", page_ref=453, cost=800, essence="-", capacity="-", avail=8, subtype="Headware", grade=None)
ULTRASOUND_SENSOR_1_6 = Augmentation("ULTRASOUND_SENSOR_1_6", page_ref=453, cost=["Rating", "*", 12_000], rating=[1, "to", 6], essence=0.25, capacity=2, avail=10, cyberlimbs=True, subtype="Headware", grade=None)
VOICE_MODULATOR_1_6 = Augmentation("VOICE_MODULATOR_1_6", page_ref=453, cost=["Rating", "*", 5000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=["Rating", "*", 3], legality=FORBIDDEN, subtype="Headware", grade=None)
# EYEWARE
CYBEREYES_1 = Augmentation("CYBEREYES_1", page_ref=454, cost=4000, rating=1, essence=0.2, capacity=4, avail=3, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_2 = Augmentation("CYBEREYES_2", page_ref=454, cost=6000, rating=2, essence=0.3, capacity=8, avail=6, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_3 = Augmentation("CYBEREYES_3", page_ref=454, cost=10000, rating=3, essence=0.4, capacity=12, avail=9, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_4 = Augmentation("CYBEREYES_4", page_ref=454, cost=14000, rating=4, essence=0.5, capacity=16, avail=12, cyberlimbs=False, subtype='Eyeware', grade=None)
FLARE_COMPENSATION_AUG = Augmentation("FLARE_COMPENSATION_AUG", page_ref=454, cost=1000, essence=0.1, capacity=1, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
IMAGE_LINK_AUG = Augmentation("IMAGE_LINK_AUG", page_ref=454, cost=1000, essence=0.1, capacity="-", avail=4, as_standard=True, subtype='Eyeware', grade=None)
LOW_LIGHT_VISION_AUG = Augmentation("LOW_LIGHT_VISION_AUG", page_ref=454, cost=1500, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
