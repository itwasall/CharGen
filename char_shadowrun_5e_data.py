...
"""
# HEADWARE
COMMLINK = Augmentation("Commlink (Aug)", page_ref=453, cost=["CommlinkCost", "+", 2000], essence=0.2, capacity=2, avail=0, cyberlimbs=True, subtype="Headware", grade=None, requires=["Subtype", "Commlink"])
CONTROL_RIG_1 = Augmentation("Control Rig (Rating 1)", page_ref=453, cost=43_000, rating=1, essence=1, capacity="-", avail=5, legality=RESTRICTED, subtype="Headware", grade=None)
CONTROL_RIG_2 = Augmentation("Control Rig (Rating 2)", page_ref=453, cost=97_000, rating=2, essence=2, capacity="-", avail=10, legality=RESTRICTED, subtype="Headware", grade=None)
CONTROL_RIG_3 = Augmentation("Control Rig (Rating 3)", page_ref=453, cost=208_000, rating=3, essence=3, capacity="-", avail=15, legality=RESTRICTED, subtype="Headware", grade=None)
CORTEX_BOMB_KINK = Augmentation("Cortex Bomb (Kink)", page_ref=453, cost=10_000, essence=0, capacity=1, avail=12, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
CORTEX_BOMB_MICROBOMB = Augmentation("Cortex Bomb (Microbomb)", page_ref=453, cost=25_000, essence=0, capacity=2, avail=16, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
CORTEX_BOMB_AREA = Augmentation("Cortex Bomb (Area)", page_ref=453, cost=40_000, essence=0, capacity=3, avail=20, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware", grade=None)
CYBERDECK = Augmentation("Cyberdeck", page_ref=453, cost=["Deck Cost", "+", 5000], essence=0.4, capacity=4, avail=5, legality=RESTRICTED, cyberlimbs=True, subtype="Headware", grade=None)
DATAJACK = Augmentation("Datajack", page_ref=453, cost=1000, essence=0.1, capacity="-", avail=2, subtype="Headware", grade=None)
DATA_LOCK_1_12 = Augmentation("Data Lock", page_ref=453, cost=["Rating", "*", 1000], rating=[1, "to", 12], essence=0.1, capacity="-", avail=["Rating", "*", 2], subtype="Headware", grade=None)
OLFACTORY_BOOSTER_1_6 = Augmentation("Olfactory Booster", page_ref=453, cost=["Rating", "*", 4000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=["Rating", "*", 3], subtype="Headware", grade=None)
SIMRIG = Augmentation("Simrig", cost=4000, essence=0.2, capacity="-", avail=12, legality=RESTRICTED, subtype="Headware", grade=None)
SKILLJACK_1_6 = Augmentation("Skilljack", page_ref=453, cost=["Rating", "*", 20000], rating=[1, "to", 6], essence=["Rating", "*", 0.1], capacity="-", avail=["Rating", "*", 2], subtype="Headware", grade=None)
TASTE_BOOSTER = Augmentation("Taste Booster", page_ref=453, cost=["Rating", "*", 3000], rating=[1, "to", 3], essence=0.2, capacity="-", avail=["Rating", "*", 3], subtype="Headware", grade=None)
TOOTH_COMPARTMENT = Augmentation("Tooth Compartment", page_ref=453, cost=800, essence="-", capacity="-", avail=8, subtype="Headware", grade=None)
ULTRASOUND_SENSOR_1_6 = Augmentation("Ultrasound Sensor", page_ref=453, cost=["Rating", "*", 12_000], rating=[1, "to", 6], essence=0.25, capacity=2, avail=10, cyberlimbs=True, subtype="Headware", grade=None)
VOICE_MODULATOR_1_6 = Augmentation("Voice Modulator", page_ref=453, cost=["Rating", "*", 5000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=["Rating", "*", 3], legality=FORBIDDEN, subtype="Headware", grade=None)
# EYEWARE
CYBEREYES_1 = Augmentation("Cybereyes (Rating 1)", page_ref=454, cost=4000, rating=1, essence=0.2, capacity=4, avail=3, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_2 = Augmentation("Cybereyes (Rating 2)", page_ref=454, cost=6000, rating=2, essence=0.3, capacity=8, avail=6, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_3 = Augmentation("Cybereyes (Rating 3)", page_ref=454, cost=10000, rating=3, essence=0.4, capacity=12, avail=9, cyberlimbs=False, subtype='Eyeware', grade=None)
CYBEREYES_4 = Augmentation("Cybereyes (Rating 4)", page_ref=454, cost=14000, rating=4, essence=0.5, capacity=16, avail=12, cyberlimbs=False, subtype='Eyeware', grade=None)
FLARE_COMPENSATION_AUG = Augmentation("Flare Compensation (Aug)", page_ref=454, cost=1000, essence=0.1, capacity=1, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
IMAGE_LINK_AUG = Augmentation("Image Link (Aug)", page_ref=454, cost=1000, essence=0.1, capacity="-", avail=4, as_standard=True, subtype='Eyeware', grade=None)
LOW_LIGHT_VISION_AUG = Augmentation("Low Light Vision (Aug)", page_ref=454, cost=1500, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
OCULAR_DRONE = Augmentation("OCULAR_DRONE", page_ref=454, cost=6000, essence="-", capacity=6, avail=6, cyberlimbs=True, subtype='Eyeware', grade=None)
RETINAL_DUPLICATION_1_6 = Augmentation("RETINAL_DUPLICATION_1_6", page_ref=454, cost=["Rating", "*", 20_000], rating=[1, "to", 6], essence=0.1, capacity=1, avail=16, legality=FORBIDDEN, cyberlimbs=True, subtype='Eyeware', grade=None)
SMARTLINK_AUG = Augmentation("SMARTLINK_AUG", page_ref=454, cost=4000, essence=0.2, capacity=3, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype='Eyeware', grade=None)
THERMOGRAPHIC_VISION_AUG = Augmentation("THERMOGRAPHIC_VISION_AUG", page_ref=454, cost=1500, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
VISION_ENHANCEMENT_AUG = Augmentation("VISION_ENHANCEMENT_AUG", page_ref=454, cost=["Rating", "*", 4000], rating=[1, "to", 3], essence=0.1, capacity=["Rating"], avail=["Rating", "*", 3], cyberlimbs=True, subtype='Eyeware', grade=None)
VISION_MAGNIFICATION_AUG = Augmentation("VISION_MAGNIFICATION_AUG", page_ref=454, cost=2000, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware', grade=None)
# EARWARE
CYBEREARS_1 = Augmentation("CYBEREARS_1", page_ref=454, cost=3000, rating=1, essence=0.2, capacity=4, avail=3, cyberlimbs=False, subtype='Earware', grade=None)
CYBEREARS_2 = Augmentation("CYBEREARS_2", page_ref=454, cost=4500, rating=2, essence=0.3, capacity=8, avail=6, cyberlimbs=False, subtype='Earware', grade=None)
CYBEREARS_3 = Augmentation("CYBEREARS_3", page_ref=454, cost=7500, rating=3, essence=0.4, capacity=12, avail=9, cyberlimbs=False, subtype='Earware', grade=None)
CYBEREARS_4 = Augmentation("CYBEREARS_4", page_ref=454, cost=11000, rating=4, essence=0.5, capacity=16, avail=12, cyberlimbs=False, subtype='Earware', grade=None)
AUDIO_ENHANCEMENT_AUG_1_3 = Augmentation("AUDIO_ENHANCEMENT_AUG_1_3", page_ref=454, cost=["Rating", "*", 4000], rating=[1, "to", 3], essence=0.1, capacity=["Rating"], avail=["Rating", "*", 3], cyberlimbs=True, subtype='Earware', grade=None)
BALANCE_AUGMENTER = Augmentation("BALANCE_AUGMENTER", page_ref=454, cost=8000, essence=0.1, capacity=4, avail=8, cyberlimbs=True, subtype='Earware', grade=None)
DAMPER = Augmentation("DAMPER", page_ref=454, cost=2250, essence=0.1, capacity=1, avail=6, cyberlimbs=True, subtype='Earware', grade=None)
SELECT_SOUND_FILTER_AUG_1_6 = Augmentation("SELECT_SOUND_FILTER_AUG_1_6", page_ref=454, cost=["Rating", "*", 3500], rating=[1, "to", 6], essence=0.1, capacity=["Rating"], avail=["Rating", "*", 3], cyberlimbs=True, subtype='Earware', grade=None)
SOUND_LINK = Augmentation("SOUND_LINK", page_ref=454, cost=1000, essence=0.1, capacity="-", avail=4, cyberlimbs=False, as_standard=True, subtype='Earware', grade=None)
SPATIAL_RECOGNIZER = Augmentation("SPATIAL_RECOGNIZER", page_ref=454, cost=4000, essence=0.1, capacity=2, avail=8, cyberlimbs=True, subtype='Earware', grade=None)
# BODYWARE
BONE_LACING_PLASTIC = Augmentation("BONE_LACING_PLASTIC", page_ref=456, cost=8000, essence=0.5, capacity="-", avail=8, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
BONE_LACING_ALUMINUM = Augmentation("BONE_LACING_ALUMINUM", page_ref=456, cost=18000, essence=1, capacity="-", avail=12, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
BONE_LACING_TITANIUM = Augmentation("BONE_LACING_TITANIUM", page_ref=456, cost=30000, essence=1.5, capacity="-", avail=16, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
DERMAL_PLANTING_1_6 = Augmentation("DERMAL_PLANTING_1_6", page_ref=456, cost=["Rating", "*", 3000], rating=[1, "to", 6], essence=["Rating", "*", 0.5], capacity="-", avail=["Rating", "*", 4], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
FINGERTIP_COMPARTMENT = Augmentation("FINGERTIP_COMPARTMENT", page_ref=456, cost=3000, essence=0.1, capacity=1, avail=4, cyberlimbs=True, subtype='Bodyware', grade=None)
GRAPPLE_GUN_AUG = Augmentation("GRAPPLE_GUN_AUG", page_ref=456, cost=5000, essence=0.5, capacity=4, avail=8, cyberlimbs=True, subtype='Bodyware', grade=None)
INTERNAL_AIR_TANK_1_3 = Augmentation("INTERNAL_AIR_TANK_1_3", page_ref=456, cost=["Rating", "*", 8000], rating=[1, "to", 3], essence=0.25, capacity=3, avail=["Rating"], cyberlimbs=True, subtype='Bodyware', grade=None)
MUSCLE_REPLACEMENT_1_3 = Augmentation("MUSCLE_REPLACEMENT_1_3", page_ref=456, cost=["Rating", "*", 25000], rating=[1, "to", 4], essence=["Rating", "*", 1], capacity="-", avail=["Rating", "*", 5], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
REACTION_ENHANCERS_1_3 = Augmentation("REACTION_ENHANCERS_1_3", page_ref=456, cost=["Rating", "*", 13000], rating=[1, "to", 3], essence=["Rating", "*", 0.3], capacity="-", avail=["Rating", "*", 5], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
SKILLWIRES_1_6 = Augmentation("SKILLWIRES_1_6", page_ref=456, cost=["Rating", "*", 20000], rating=[1, "to", 6], essence=["Rating", "*", 0.1], capacity="-", avail=["Rating", "*", 4], cyberlimbs=False, subtype='Bodyware', grade=None)
SMUGGLING_COMPARTMENT = Augmentation("SMUGGLING_COMPARTMENT", page_ref=456, cost=7500, essence=0.2, capacity=2, avail=6, cyberlimbs=True, subtype='Bodyware', grade=None)
WIRED_REFLEXES_1 = Augmentation("WIRED_REFLEXES_1", page_ref=456, cost=39000, essence=2, capacity="-", avail=8, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
WIRED_REFLEXES_2 = Augmentation("WIRED_REFLEXES_2", page_ref=456, cost=149000, essence=3, capacity="-", avail=12, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
WIRED_REFLEXES_3 = Augmentation("WIRED_REFLEXES_3", page_ref=456, cost=217000, essence=5, capacity="-", avail=20, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware', grade=None)
# CYBERLIMBS
FULL_ARM_OBV = Augmentation("FULL_ARM_OBV", page_ref=457, cost=15000, essence=1, capacity=15, avail=4, subtype='Cyberlimbs Obvious', grade=None)
FULL_LEG_OBV = Augmentation("FULL_LEG_OBV", page_ref=457, cost=15000, essence=1, capacity=20, avail=4, subtype='Cyberlimbs Obvious', grade=None)
HAND_OBV = Augmentation("HAND_OBV", page_ref=457, cost=5000, essence=0.25, capacity=4, avail=2, subtype='Cyberlimbs Obvious', grade=None)
FOOT_OBV = Augmentation("FOOT_OBV", page_ref=457, cost=5000, essence=0.25, capacity=4, avail=2, subtype='Cyberlimbs Obvious', grade=None)
LOWER_ARM_OBV = Augmentation("LOWER_ARM_OBV", page_ref=457, cost=10000, essence=0.45, capacity=10, avail=4, subtype='Cyberlimbs Obvious', grade=None)
LOWER_LEG_OBV = Augmentation("LOWER_LEG_OBV", page_ref=457, cost=10000, essence=0.45, capacity=12, avail=4, subtype='Cyberlimbs Obvious', grade=None)
TORSO_OBV = Augmentation("TORSO_OBV", page_ref=457, cost=20000, essence=1.5, capacity=10, avail=12, subtype='Cyberlimbs Obvious', grade=None)
SKULL_OBV = Augmentation("SKULL_OBV", page_ref=457, cost=10000, essence=0.75, capacity=4, avail=16, subtype='Cyberlimbs Obvious', grade=None)
FULL_ARM_SYNTH = Augmentation("FULL_ARM_SYNTH", page_ref=457, cost=20000, essence=1, capacity=8, avail=4, subtype='Cyberlimbs Synthetic', grade=None)
FULL_LEG_SYNTH = Augmentation("FULL_LEG_SYNTH", page_ref=457, cost=20000, essence=1, capacity=10, avail=4, subtype='Cyberlimbs Synthetic', grade=None)
HAND_SYNTH = Augmentation("HAND_SYNTH", page_ref=457, cost=6000, essence=0.25, capacity=2, avail=2, subtype='Cyberlimbs Synthetic', grade=None)
FOOT_SYNTH = Augmentation("FOOT_SYNTH", page_ref=457, cost=6000, essence=0.25, capacity=2, avail=2, subtype='Cyberlimbs Synthetic', grade=None)
LOWER_ARM_SYNTH = Augmentation("LOWER_ARM_SYNTH", page_ref=457, cost=12000, essence=0.45, capacity=5, avail=4, subtype='Cyberlimbs Synthetic', grade=None)
LOWER_LEG_SYNTH = Augmentation("LOWER_LEG_SYNTH", page_ref=457, cost=12000, essence=0.45, capacity=6, avail=4, subtype='Cyberlimbs Synthetic', grade=None)
TORSO_SYNTH = Augmentation("TORSO_SYNTH", page_ref=457, cost=25000, essence=1.5, capacity=5, avail=12, subtype='Cyberlimbs Synthetic', grade=None)
SKULL_SYNTH = Augmentation("SKULL_SYNTH", page_ref=457, cost=15000, essence=0.75, capacity=2, avail=16, subtype='Cyberlimbs Synthetic', grade=None)
# CYBERLIMB ENHANCEMENTS
CYBERLIMB_EN_AGILITY = Augmentation("CYBERLIMB_EN_AGILITY", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=["Rating", "*", 3], legality=RESTRICTED, subtype='Cyberlimbs Enhancement', grade=None)
CYBERLIMB_EN_ARMOR = Augmentation("CYBERLIMB_EN_ARMOR", page_ref=457, cost=["Rating", "*", 3000], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=["Rating", "*", 5], subtype='Cyberlimbs Enhancement', grade=None)
CYBERLIMB_EN_STRENGTH = Augmentation("CYBERLIMB_EN_STRENGTH", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=["Rating", "*", 3], legality=RESTRICTED, subtype='Cyberlimbs Enhancement', grade=None)
# CYBERLIMB ACCESSORIES
CYBERARM_GYROMOUNT = Augmentation("CYBERARM_GYROMOUNT", page_ref=457, cost=6000, essence="-", capacity=8, avail=12, legality=FORBIDDEN, cymberlimbs=True, subtype='Cyberlimb Accessory', grade=None)
CYBERARM_SLIDE = Augmentation("CYBERARM_SLIDE", page_ref=457, cost=3000, essence="-", capacity=3, avail=12, legality=RESTRICTED, cymberlimbs=True, subtype='Cyberlimb Accessory', grade=None)
CYBER_HOLSTER = Augmentation("CYBER_HOLSTER", page_ref=457, cost=2000, essence="-", capacity=5, avail=8, legality=RESTRICTED, cymberlimbs=True, subtype='Cyberlimb Accessory', grade=None)
HYDRAULIC_JACKS_1_6 = Augmentation("HYDRAULIC_JACKS_1_6", page_ref=457, cost=["Rating", "*", 2500], rating=[1, "to", 6], essence="-", capacity=["Rating"], avail=9, cymberlimbs=True, subtype='Cyberlimb Accessory', grade=None)
LARGE_SMUGGLING_COMPARMENT = Augmentation("LARGE_SMUGGLING_COMPARMENT", page_ref=457, cost=8000, essence="-", capacity=5, avail=6, cymberlimbs=True, subtype='Cyberlimb Accessory', grade=None)
# CYBER IMPLANT WEAPONS - AUGMENTATION ENTRY
CYBER_HOLD_OUT_PISTOL = Augmentation("CYBER_HOLD_OUT_PISTOL", page_ref=458, cost=2000, essence=0.1, capacity=2, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_LIGHT_PISTOL = Augmentation("CYBER_LIGHT_PISTOL", page_ref=458, cost=3900, essence=0.25, capacity=4, avail=10, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_MACHINE_PISTOL = Augmentation("CYBER_MACHINE_PISTOL", page_ref=458, cost=3500, essence=0.5, capacity=6, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_HEAVY_PISTOL = Augmentation("CYBER_HEAVY_PISTOL", page_ref=458, cost=4300, essence=0.5, capacity=6, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_SUBMACHINE_GUN = Augmentation("CYBER_SUBMACHINE_GUN", page_ref=458, cost=4800, essence=1, capacity=8, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_SHOTGUN = Augmentation("CYBER_SHOTGUN", page_ref=458, cost=8500, essence=1.25, capacity=10, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_MICROGRENADE_LAUNCHER = Augmentation("CYBER_MICROGRENADE_LAUNCHER", page_ref=458, cost=30000, essence=1.5, capacity=15, avail=20, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_HAND_BLADE = Augmentation("CYBER_HAND_BLADE", page_ref=458, cost=2500, essence=0.25, capacity=2, avail=10, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_HAND_RAZOR = Augmentation("CYBER_HAND_RAZOR", page_ref=458, cost=1250, essence=0.2, capacity=2, avail=8, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_SPURS = Augmentation("CYBER_SPURS", page_ref=458, cost=5000, essence=0.3, capacity=3, avail=12, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
CYBER_SHOCK_HAND = Augmentation("CYBER_SHOCK_HAND", page_ref=458, cost=5000, essence=0.25, capacity=4, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons", grade=None)
...
# BIOWARE
ADRENALINE_PUMP_1_3 = Augmentation("ADRENALINE_PUMP_1_3", page_ref=460, cost=["Rating", "*", 55000], rating=[1, "to", 3], essence=["Rating", "*", 0.75], avail=["Rating", "*", 6], legality=FORBIDDEN, subtype="Bioware", grade=None)
BONE_DENSITY_AUGMENTATION_1_4 = Augmentation("BONE_DENSITY_AUGMENTATION_1_4", page_ref=460, cost=["Rating", "*", 5000], rating=[1, "to", 4], essence=["Rating", "*", 0.3], avail=["Rating", "*", 4], subtype="Bioware", grade=None)
CATS_EYE = Augmentation("CATS_EYE", page_ref=460, cost=4000, essence=0.1, avail=4, subtype="Bioware", grade=None)
ENHANCED_ARTICULATION = Augmentation("ENHANCED_ARTICULATION", page_ref=460, cost=24000, essence=0.3, avail=12, subtype="Bioware", grade=None)
MUSCLE_AUGMENTATION_1_4 = Augmentation("MUSCLE_AUGMENTATION_1_4", page_ref=460, cost=["Rating", "*", 31000], rating=[1, "to", 4], essence=["Rating", "*", 0.2], avail=["Rating", "*", 5], legality=RESTRICTED, subtype="Bioware", grade=None)
MUSCLE_TONER_1_4 = Augmentation("MUSCLE_TONER_1_4", page_ref=460, cost=["Rating", "*", 32000], rating=[1, "to", 4], essence=["Rating", "*", 0.2], avail=["Rating", "*", 5], legality=RESTRICTED, subtype="Bioware", grade=None)
ORTHOSKIN_1_4 = Augmentation("ORTHOSKIN_1_4", page_ref=460, cost=["Rating", "*", 6000], rating=[1, "to", 4], essence=["Rating", "*", 0.25], avail=["Rating", "*", 5], legality=RESTRICTED, subtype="Bioware", grade=None)
PATHOGENIC_DEFENSE_1_6 = Augmentation("PATHOGENIC_DEFENSE_1_6", page_ref=460, cost=["Rating", "*", 4500], rating=[1, "to", 6], essence=["Rating", "*", 0.1], avail=["Rating", "*", 2], subtype="Bioware", grade=None)
PLATELET_FACTORIES = Augmentation("PLATELET_FACTORIES", page_ref=460, cost=17000, essence=0.2, avail=12, subtype="Bioware", grade=None)
SKIN_POCKET = Augmentation("SKIN_POCKET", page_ref=460, cost=12000, essence=0.1, avail=4, subtype="Bioware", grade=None)
SUPRATHYROID_GLAND = Augmentation("SUPRATHYROID_GLAND", page_ref=460, cost=140_000, essence=0.7, avail=20, legality=RESTRICTED, subtype="Bioware", grade=None)
SYMBIOTES_1_4 = Augmentation("SYMBIOTES_1_4", page_ref=460, cost=["Rating", "*", 3500], rating=[1, "to", 4], essence=["Rating", "*", 0.2], avail=["Rating", "*", 5], subtype="Bioware", grade=None)
SYNTHCARDIUM_1_3 = Augmentation("SYNTHCARDIUM_1_3", page_ref=460, cost=["Rating", "*", 30000], rating=[1, "to", 3], essence=["Rating", "*", 0.1], avail=["Rating", "*", 4], subtype="Bioware", grade=None)
TAILORED_PHEROMONES_1_3 = Augmentation("TAILORED_PHEROMONES_1_3", page_ref=460, cost=["Rating", "*", 31000], rating=[1, "to", 3], essence=["Rating", "*", 0.2], avail=["Rating", "*", 4], legality=RESTRICTED, subtype="Bioware", grade=None)
TOXIN_EXTRACTOR_1_6 = Augmentation("TOXIN_EXTRACTOR_1_6", page_ref=460, cost=["Rating", "*", 4800], rating=[1, "to", 6], essence=["Rating", "*", 0.2], avail=["Rating", "*", 3], subtype="Bioware", grade=None)
TRACHEAL_FILTER_1_6 = Augmentation("TRACHEAL_FILTER_1_6", page_ref=460, cost=["Rating", "*", 4500], rating=[1, "to", 6], essence=["Rating", "*", 0.1], avail=["Rating", "*", 3], subtype="Bioware", grade=None)
# CULTURED BIOWARE
CEREBRAL_BOOSTER_1_3 = Augmentation("CEREBRAL_BOOSTER_1_3", page_ref=461, cost=["Rating", "*", 31500], rating=[1, "to", 3], essence=["Rating", "*", 0.2], avail=["Rating", "*", 6], subtype="Cultured Bioware", grade=None)
DAMAGE_COMPENSATORS_1_12 = Augmentation("DAMAGE_COMPENSATORS_1_12", page_ref=461, cost=["Rating", "*", 2000], rating=[1, "to", 12], essence=["Rating", "*", 0.1], avail=["Rating", "*", 3], legality=FORBIDDEN, subtype="Cultured Bioware", grade=None)
MNEMONIC_ENCHANCER_1_3 = Augmentation("MNEMONIC_ENCHANCER_1_3", page_ref=461, cost=["Rating", "*", 9000], rating=[1, "to", 3], essence=["Rating", "*", 0.1], avail=["Rating", "*", 5], subtype="Cultured Bioware", grade=None)
PAIN_EDITOR = Augmentation("PAIN_EDITOR", page_ref=461, cost=48000, essence=0.3, avail=18, legality=FORBIDDEN, subtype="Cultured Bioware", grade=None)
REFLEX_RECORDER = Augmentation("REFLEX_RECORDER", page_ref=461, cost=14000, essence=0.1, avail=10, subtype="Cultured Bioware", grade=None)
SLEEP_REGULATOR = Augmentation("SLEEP_REGULATOR", page_ref=461, cost=12000, essence=0.1, avail=6, subtype="Cultured Bioware", grade=None)
SYNAPTIC_BOOSTER_1_3 = Augmentation("SYNAPTIC_BOOSTER_1_3", page_ref=461, cost=["Rating", "*", 95000], rating=[1, "to", 3], essence=["Rating", "*", 0.5], avail=["Rating", "*", 6], legality=RESTRICTED, subtype="Cultured Bioware", grade=None)
"""
    PRIORITY TABLE
"""
PRIORITY_TABLE = { 
