...
EXOTIC_MELEE_WEAPON = Skill("Exotic_melee_weapon", AGILITY, "Active", spec=['Assault Cannons', 'Grenade Launchers', 'Guided Missiles', 'Machine Guns', 'Rocket Launchers'])
EXOTIC_RANGED_WEAPON = Skill("Exotic_ranged_weapon", AGILITY, "Active")
GUNNERY = Skill("Gunnery", AGILITY, "Active", spec=['Balance', 'Climbing', 'Dance', 'Leaping', 'Parkour', 'Rolling'])
...
THROWING = Skill("Throwing", AGILITY, "Active", spec=['Aerodynamic', 'Blades', 'Non-Aerodynamic'])
...
AERONAUTICS_MECHANIC = Skill("Aeronautics_Mechanic", LOGIC, "Active", spec=['Aerospace', 'Fixed Wing', 'LTA (Blimp)', 'Rotary Wing', 'Tilt Wing', 'Vector Thrust'])
...
ARTIFICING = Skill("Artificing", MAGIC, "Active", spec=['Focus Analysis', 'Spell Crafting', 'Spirit Crafting', 'Power Crafting', 'Weapon Crafting'])
BANISHING = Skill("Banishing", MAGIC, "Active", spec=['Spirit Type'])
...
SUMMONING = Skill("Summoning", MAGIC, "Active", spec=['Spirit Type'])
# =============== RESONANCE ==============
