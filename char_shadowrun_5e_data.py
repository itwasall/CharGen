...
"""
# =============== TASERS =================
DEFINANCE_EX_SHOCKER = Firearm("Definance EX Shocker", cost=250, page_ref=424, avail="-", subtype="Taser", damage=[9, STUN, ELECTRICAL], mods=None)
YAMAHA_PULSAR = Firearm("Yamaha Pulsar", cost=180, page_ref=424, avail="-", subtype="Taser", mods=None)
# =============== HOLD-OUTS ==============
FINCHETTI_TIFFANI_NEEDLER = Firearm("Finchetti Tiffani Needler", cost=1000, page_ref=425, avail=[5, RESTRICTED], subtype="Hold-Outs", mods=None)
STREETLINE_SPECIAL = Firearm("Streetline Special", cost=120, page_ref=425, avail=[4, RESTRICTED], subtype="Hold-Outs", mods=None)
WALTHER_PALM_PISTOL = Firearm("Walther Palm Pistol", cost=180, page_ref=425, avail=[4, RESTRICTED], subtype="Hold-Out", mods=None)
# =============== LIGHT PISTOLS ==========
ARES_LIGHT_FIRE_75 = Firearm("Ares_Light Fire 75", cost=1250, page_ref=425, avail=[6, RESTRICTED], subtype="Light Pistol", mods=None)
ARES_LIGHT_FIRE_70 = Firearm("Ares Light Fire 70", cost=200, page_ref=425, avail=[3, RESTRICTED], subtype="Light Pistol", mods=None)
BERETTA_201T = Firearm("Beretta 201T", cost=210, page_ref=425, avail=[7, RESTRICTED], subtype="Light Pistol", mods=None)
COLT_AMERICA_L36 = Firearm("Colt America L36", cost=320, page_ref=425, avail=[4, RESTRICTED], subtype="Light Pistol", mods=None)
FICHETTI_SECURITY_600 = Firearm("Fichetti Security 600", cost=350, page_ref=426, avail=[6, RESTRICTED], subtype="Light Pistol", mods=None)
TAURUS_OMNI_6 = Firearm("Taurus Omni 6", cost=300, page_ref=426, avail=[3, RESTRICTED], subtype="Light Pistol", mods=None)
# =============== HEAVY PISTOLS ==========
ARES_PREDATOR_V = Firearm("Ares Predator V", cost=725, page_ref=426, avail=[5, RESTRICTED], subtype="Heavy Pistol", mods=None)
ARES_VIPER_SHOTGUN = Firearm("Ares Viper Shotgun", cost=380, page_ref=426, avail=[8, RESTRICTED], subtype="Heavy Pistol", mods=None)
BROWNING_ULTRA_POWER = Firearm("Browning Ultra Power", cost=640, page_ref=426, avail=[4, RESTRICTED], subtype="Heavy Pistol", mods=None)
COLT_GOVERNMENT_2066 = Firearm("Colt Government 2066", cost=425, page_ref=426, avail=[7, RESTRICTED], subtype="Heavy Pistol", mods=None)
REMINGTON_ROOMSWEEPER = Firearm("Remington Roomsweeper", cost=250, page_ref=426, avail=[6, RESTRICTED], subtype="Heavy Pistol", mods=None)
...
RUGER_SUPER_WARHAWK = Firearm("Ruger Super Warhawk", cost=400, page_ref=427, avail=[4, RESTRICTED], subtype="Heavy Pistol", mods=None)
# =============== MACHINE PISTOLS ========
ARES_CRUSADER_II = Firearm("Ares Crusader II", cost=830, page_ref=427, avail=[9, RESTRICTED], subtype="Machine Pistol", mods=None)
CESKA_BLACK_SCORPIAN = Firearm("Ceska Black Scorpian", cost=270, page_ref=427, avail=[6, RESTRICTED], subtype="Machine Pistol", mods=None)
STEYR_TMP = Firearm("Steyr TMP", cost=350, page_ref=427, avail=[8, RESTRICTED], subtype="Machine Pistol", mods=None)
# =============== SMGS ===================
COLT_COBRA_TZ_120  = Firearm("Colt Cobra TZ-120", cost=660, page_ref=427, avail=[5, RESTRICTED], subtype="Submachine Gun", mods=None)
FN_P93_PRAETOR = Firearm("FN-P93 Praetor", cost=900, page_ref=427, avail=[11, RESTRICTED], subtype="Submachine Gun", mods=None)
HK_227 = Firearm("HK-227", cost=730, page_ref=427, avail=[8, RESTRICTED], subtype="Submachine Gun", mods=None)
INGRAM_SMARTGUN_X = Firearm("Ingram Smartgun X", cost=800, page_ref=427, avail=[6, RESTRICTED], subtype="Submachine Gun", mods=None)
SCK_MODEL_100 = Firearm("SCK Model 100", cost=875, page_ref=428, avail=[6, RESTRICTED], subtype="Submachine Gun", mods=None)
UZI_IV = Firearm("Uzi IV", cost=450, page_ref=428, avail=[4, RESTRICTED], subtype="Submachine Gun", mods=None)
# =============== ASSAULT RIFLE ==========
AK_97 = Firearm("AK 97", cost=950, page_ref=428, avail=[4 ,RESTRICTED], subtype="Assault Rifle", mods=None)
ARES_ALPHA = Firearm("Ares Alpha", cost=2650, page_ref=428, avail=[11, FORBIDDEN], subtype="Assault Rifle", mods=None)
ARES_ALPHA_GRENADE_LAUNCHER = Firearm("Ares Alpha Grenade Launcher", cost=0, page_ref=428, avail=[11, FORBIDDEN], subtype="Assault Rifle", requires=ARES_ALPHA, mods=None)
COLT_M23 = Firearm("Colt-M23", cost=550, page_ref=428, avail=[4, RESTRICTED], subtype="Assault Rifle", mods=None)
FN_HAR = Firearm("FN HAR", cost=1500, page_ref=428, avail=[8, RESTRICTED], subtype="Assault Rifle", mods=None)
YAMAHA_RAIDEN = Firearm("Yamaha Raiden", cost=2600, page_ref=428, avail=[14, FORBIDDEN], subtype="Assault Rifle", mods=None)
# =============== SNIPERS ================
ARES_DESERT_STRIKE = Firearm("Ares Desert Strike", cost=17_500, page_ref=28, avail=[10, FORBIDDEN], subtype="Sniper Rifle", mods=None)
CAVALIER_ARMS_CROCKETT_EBR = Firearm("Cavalier Arms Crockett EBR", cost=10_300, page_ref=28, avail=[12, FORBIDDEN], subtype="Sniper Rifle", mods=None)
RANGER_ARMS_SM_5 = Firearm("Ranger Arms SM-5", cost=28_000, page_ref=29, avail=[16, FORBIDDEN], subtype="Sniper Rifle", mods=None)
REMINGTON_950 = Firearm("Remington 950", cost=2100, page_ref=29, avail=[4, RESTRICTED], subtype="Sniper Rifle", mods=None)
RUGER_100 = Firearm("Ruger 100", cost=1300, page_ref=29, avail=[4, RESTRICTED], subtype="Sniper Rifle", mods=None)
# =============== SHOTGUNS ===============
DEFIANCE_T_250 = Firearm("Defiance T-250", cost=450, page_ref=429, avail=[4, RESTRICTED], subtype="Shotgun", mods=None)
ENFIELD_AS_7 = Firearm("Enfield AS-7", cost=1100, page_ref=429, avail=[12, FORBIDDEN], subtype="Shotgun", mods=None)
PJSS_MODEL_55  = Firearm("PJSS Model 55", cost=1000, page_ref=429, avail=[0, RESTRICTED], subtype="Shotgun", mods=None)
# =============== SPECiAL ================
ARES_S_III_SUPER_SQUIRT = Firearm("Ares S-III Super Squirt", cost=950, page_ref=429, avail=[0, RESTRICTED], subtype="Special", damage="Chemical", mods=None)
FICHETTI_PAIN_INDUCER = Firearm("Fichetti Pain Inducer", cost=5000, page_ref=430, avail=[11, FORBIDDEN], subtype="Special", damage="Special", mods=None)
PARASHIELD_DART_PISTOL = Firearm("Parashield Dart Pistol", cost=600, page_ref=430, avail=[4, FORBIDDEN], subtype="Special", damage="As Drug/Toxin", mods=None)
PARASHIELD_DART_RIFLE = Firearm("Parashield Dart Rifle", cost=1200, page_ref=430, avail=[6, FORBIDDEN], subtype="Special", damage="As Drug/Toxin", mods=None)
# =============== MACHINE ================
INGRAM_VALIANT = Firearm("Ingram Valiant", cost=5800, page_ref=430, avail=[12, FORBIDDEN], subtype="Machine Gun", mods=None)
STONER_ARES_M202 = Firearm("Stoner-Ares M202", cost=7000, page_ref=430, avail=[12, FORBIDDEN], subtype="Machine Gun", mods=None)
RPK_HMG = Firearm("RPK HMG", cost=16_300, page_ref=430, avail=[16, FORBIDDEN], subtype="Machine Gun", mods=None)
# =============== LAUNCHER ===============
ARES_ANTIOCH_2 = Firearm("Ares Antioch-2", cost=3200, page_ref=431, avail=[8, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
ARMTECH_MGL_12 = Firearm("ArmTech MGL-12", cost=5000, page_ref=431, avail=[10, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
AZTECHNOLOGY_STRIKER = Firearm("Aztechnology Striker", cost=1200, page_ref=431, avail=[10, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
KRIME_CANNON = Firearm("Krime Cannon", cost=21_000, page_ref=431, avail=[20, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
ONOTARI_INTERCEPTOR = Firearm("Onotari Interceptor", cost=14_000, page_ref=431, avail=[18, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
PANTHER_XXL = Firearm("Panther XXL", cost=43_000, page_ref=431, avail=[20, FORBIDDEN], subtype="Cannon/Launcher", mods=None)
...
CHAMELEON_SUIT = Armor("Chameleon Suit", cost=1700, page_ref=436, avail=[10, RESTRICTED], armor_rating=9, mods=None)
FULL_BODY_ARMOR = Armor("Full Body Armor", cost=2000, page_ref=436, avail=[14, RESTRICTED], armor_rating=15, mods=None)
FULL_HELMET = Armor("Full Helmet", cost=500, page_ref=436, avail=[14, RESTRICTED], requires=FULL_BODY_ARMOR, armor_rating=3, mods=None)
# FULL_BODY_ARMOR_CHEMICAL_SEAL = ArmorModification("Chemical Seal", cost=6000, page_ref=436, avail=[FULL_BODY_ARMOR.avail[0] + 6, RESTRICTED], requires=FULL_BODY_ARMOR, armor_rating="-")
# FULL_BODY_ARMOR_ENVIRONMENTAL_ADAPTATION = ArmorModification("Environmental Adaptation", 1000, page_ref=436, avail=[FULL_BODY_ARMOR.avail[0] + 3, RESTRICTED], requires=FULL_BODY_ARMOR, armor_rating="-")
...
BALLISTIC_SHIELD = Armor("Ballistic Shield", cost=1200, page_ref=438, avail=[12, RESTRICTED], armor_rating=6, subtype="Shield", mods=None)
RIOT_SHIELD = Armor("Riot Shield", cost=1500, page_ref=438, avail=[10, RESTRICTED], armor_rating=6, subtype="Shield", mods=None)
...
THERMAL_DAMPING = ArmorModification("Thermal Damping", cost=["ArmorRating", "*", 500], page_ref=438, avail=[10, RESTRICTED], capacity="ArmorRating", requires=["Category", "Armor"])
...
BINOCULARS = Electronics(f"Binoculars", cost=["Capacity", "*", 50], page_ref=444, rating="-", avail="-", capacity=[1, "to", 3], subtype="Optical/Imaging Devices")
...
EYE_CONTACTS = Electronics(f"Eye Contacts", cost=["Capacity", "*", 200], page_ref=444, rating="-", avail="-", capacity=[1, "to", 3], subtype="Optical/Imaging Devices")
...
IMAGE_LINK = Electronics("Image Link", cost=25, page_ref=444, rating="-", avail="-", capacity=1, subtype="Vision Enhancement", requires=["subtype", "Optical/Imaging Devices"])
SMARTLINK = Electronics("Smartlink", cost=2000, page_ref=444, rating="-", avail=[4, RESTRICTED], capacity=1, subtype="Vision Enhancement", requires=["subtype", "Optical/Imaging Devices"])
...
# HANDHELD_HOUSING = Electronics("Handheld Housing", cost=["Capacity", "*", 100], page_ref=445, rating=[1, "to", 3], avail="-", capacity=[1, "to", 3], housing=[{k:d} for k, d in SENSOR_HOUSINGS.items() if d <= 3], sensor_function=SENSOR_FUNCTIONS, subtype="Sensor Housing")
HANDHELD_HOUSING = Electronics("Handheld Housing", cost=["Capacity", "*", 100], page_ref=445, rating=[1, "to", 3], avail="-", capacity=[1, "to", 3], subtype="Sensor Housing")
# WALL_MOUNTED_HOUSING = Electronics("Wall-Mounted Housing", cost=["Capacity", "*", 250], page_ref=445, rating=[1, "to", 4], avail="-", capacity=[1, "to", 6], housing=[{k:d} for k, d in SENSOR_HOUSINGS.items() if d <= 4], sensor_function=SENSOR_FUNCTIONS, subtype="Sensor Housing")
WALL_MOUNTED_HOUSING = Electronics("Wall-Mounted Housing", cost=["Capacity", "*", 250], page_ref=445, rating=[1, "to", 4], avail="-", capacity=[1, "to", 6], subtype="Sensor Housing")
# SENSOR_ARRAY = Electronics("Sensor Array", cost=["Rating", "*", 1000], page_ref=445, rating=[2, "to", 8], avail="-", capacity=6, housing=SENSOR_HOUSINGS, sensor_function=SENSOR_FUNCTIONS, subtype="Sensor Housing")
SENSOR_ARRAY = Electronics("Sensor Array", cost=["Rating", "*", 1000], page_ref=445, rating=[2, "to", 8], avail="-", capacity=6, subtype="Sensor Type")
# SINGLE_SENSOR = Electronics("Single Sensor", cost=["Rating", "*", 100], page_ref=445, rating=[2, "to", 8], avail="-", capacity=1, housing=SENSOR_HOUSINGS, sensor_function=SENSOR_FUNCTIONS, subtype="Sensor Housing")
SENSOR_SINGLE = Electronics("Single Sensor", cost=["Rating", "*", 100], page_ref=445, rating=[2, "to", 8], avail="-", capacity=1, subtype="Sensor Type")
# =============== SECURITY DEVICES====
...
"""
# HEADWARE
COMMLINK = Augmentation("COMMLINK", page_ref=453, cost=["Commlink Cost", "+", 2000], essence=0.2, capacity=2, avail="-", cyberlimbs=True, subtype="Headware")
CONTROL_RIG_1 = Augmentation("CONTROL_RIG_1", page_ref=453, cost=43_000, rating=1, essence=1, capacity="-", avail=[5, RESTRICTED], subtype="Headware")
CONTROL_RIG_2 = Augmentation("CONTROL_RIG_2", page_ref=453, cost=97_000, rating=2, essence=2, capacity="-", avail=[10, RESTRICTED], subtype="Headware")
CONTROL_RIG_3 = Augmentation("CONTROL_RIG_3", page_ref=453, cost=208_000, rating=3, essence=3, capacity="-", avail=[15, RESTRICTED], subtype="Headware")
CORTEX_BOMB_KINK = Augmentation("CORTEX_BOMB_KINK", page_ref=453, cost=10_000, essence=0, capacity=1, avail=[12, FORBIDDEN], cyberlimbs=True, subtype="Headware")
CORTEX_BOMB_MICROBOMB = Augmentation("CORTEX_BOMB_MICROBOMB", page_ref=453, cost=25_000, essence=0, capacity=2, avail=[16, FORBIDDEN], cyberlimbs=True, subtype="Headware")
CORTEX_BOMB_AREA = Augmentation("CORTEX_BOMB_AREA", page_ref=453, cost=40_000, essence=0, capacity=3, avail=[20, FORBIDDEN], cyberlimbs=True, subtype="Headware")
CYBERDECK = Augmentation("CYBERDECK", page_ref=453, cost=["Deck Cost", "+", 5000], essence=0.4, capacity=4, avail=[5, RESTRICTED], cyberlimbs=True, subtype="Headware")
DATAJACK = Augmentation("DATAJACK", page_ref=453, cost=1000, essence=0.1, capacity="-", avail=2, subtype="Headware")
DATA_LOCK_1_12 = Augmentation("DATA_LOCK_1_12", page_ref=453, cost=["Rating", "*", 1000], rating=[1, "to", 12], essence=0.1, capacity="-", avail=[["Rating", "*", 2]], subtype="Headware")
OLFACTORY_BOOSTER_1_6 = Augmentation("OLFACTORY_BOOSTER_1_6", page_ref=453, cost=["Rating", "*", 4000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=[["Rating", "*", 3]], subtype="Headware")
SIMRIG = Augmentation("SIMRIG", cost=4000, essence=0.2, capacity="-", avail=[12, RESTRICTED], subtype="Headware")
SKILLJACK_1_6 = Augmentation("SKILLJACK_1_6", page_ref=453, cost=["Rating", "*", 20000], rating=[1, "to", 6], essence=["Rating", "*", 0.1], capacity="-", avail=[["Rating", "*", 2]], subtype="Headware")
TASTE_BOOSTER = Augmentation("TASTE_BOOSTER", page_ref=453, cost=["Rating", "*", 3000], rating=[1, "to", 3], essence=0.2, capacity="-", avail=[["Rating", "*", 3]], subtype="Headware")
TOOTH_COMPARTMENT = Augmentation("TOOTH_COMPARTMENT", page_ref=453, cost=800, essence="-", capacity="-", avail=8, subtype="Headware")
ULTRASOUND_SENSOR_1_6 = Augmentation("ULTRASOUND_SENSOR_1_6", page_ref=453, cost=["Rating", "*", 12_000], rating=[1, "to", 6], essence=0.25, capacity=2, avail=10, cyberlimbs=True, subtype="Headware")
VOICE_MODULATOR_1_6 = Augmentation("VOICE_MODULATOR_1_6", page_ref=453, cost=["Rating", "*", 5000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=[["Rating", "*", 3], FORBIDDEN], subtype="Headware")
# EYEWARE
CYBEREYES_1 = Augmentation("CYBEREYES_1", page_ref=454, cost=4000, rating=1, essence=0.2, capacity=4, avail=3, cyberlimbs=False, subtype='Eyeware')
CYBEREYES_2 = Augmentation("CYBEREYES_2", page_ref=454, cost=6000, rating=2, essence=0.3, capacity=8, avail=6, cyberlimbs=False, subtype='Eyeware')
CYBEREYES_3 = Augmentation("CYBEREYES_3", page_ref=454, cost=10000, rating=3, essence=0.4, capacity=12, avail=9, cyberlimbs=False, subtype='Eyeware')
CYBEREYES_4 = Augmentation("CYBEREYES_4", page_ref=454, cost=14000, rating=4, essence=0.5, capacity=16, avail=12, cyberlimbs=False, subtype='Eyeware')
FLARE_COMPENSATION_AUG = Augmentation("FLARE_COMPENSATION_AUG", page_ref=454, cost=1000, essence=0.1, capacity=1, avail=4, cyberlimbs=True, subtype='Eyeware')
IMAGE_LINK_AUG = Augmentation("IMAGE_LINK_AUG", page_ref=454, cost=1000, essence=0.1, capacity="-", avail=4, as_standard=True, subtype='Eyeware')
LOW_LIGHT_VISION_AUG = Augmentation("LOW_LIGHT_VISION_AUG", page_ref=454, cost=1500, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware')
OCULAR_DRONE = Augmentation("OCULAR_DRONE", page_ref=454, cost=6000, essence="-", capacity=6, avail=6, cyberlimbs=True, subtype='Eyeware')
RETINAL_DUPLICATION_1_6 = Augmentation("RETINAL_DUPLICATION_1_6", page_ref=454, cost=["Rating", "*", 20_000], rating=[1, "to", 6], essence=0.1, capacity=1, avail=[16, FORBIDDEN], cyberlimbs=True, subtype='Eyeware')
SMARTLINK_AUG = Augmentation("SMARTLINK_AUG", page_ref=454, cost=4000, essence=0.2, capacity=3, avail=[8, RESTRICTED], cyberlimbs=True, subtype='Eyeware')
THERMOGRAPHIC_VISION_AUG = Augmentation("THERMOGRAPHIC_VISION_AUG", page_ref=454, cost=1500, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware')
VISION_ENHANCEMENT_AUG = Augmentation("VISION_ENHANCEMENT_AUG", page_ref=454, cost=["Rating", "*", 4000], rating=[1, "to", 3], essence=0.1, capacity=["Rating"], avail=[["Rating", "*", 3]], cyberlimbs=True, subtype='Eyeware')
VISION_MAGNIFICATION_AUG = Augmentation("VISION_MAGNIFICATION_AUG", page_ref=454, cost=2000, essence=0.1, capacity=2, avail=4, cyberlimbs=True, subtype='Eyeware')
# EARWARE
CYBEREARS_1 = Augmentation("CYBEREARS_1", page_ref=454, cost=3000, rating=1, essence=0.2, capacity=4, avail=3, cyberlimbs=False, subtype='Earware')
CYBEREARS_2 = Augmentation("CYBEREARS_2", page_ref=454, cost=4500, rating=2, essence=0.3, capacity=8, avail=6, cyberlimbs=False, subtype='Earware')
CYBEREARS_3 = Augmentation("CYBEREARS_3", page_ref=454, cost=7500, rating=3, essence=0.4, capacity=12, avail=9, cyberlimbs=False, subtype='Earware')
CYBEREARS_4 = Augmentation("CYBEREARS_4", page_ref=454, cost=11000, rating=4, essence=0.5, capacity=16, avail=12, cyberlimbs=False, subtype='Earware')
AUDIO_ENHANCEMENT_AUG_1_3 = Augmentation("AUDIO_ENHANCEMENT_AUG_1_3", page_ref=454, cost=["Rating", "*", 4000], rating=[1, "to", 3], essence=0.1, capacity=["Rating"], avail=[["Rating", "*", 3]], cyberlimbs=True, subtype='Earware')
BALANCE_AUGMENTER = Augmentation("BALANCE_AUGMENTER", page_ref=454, cost=8000, essence=0.1, capacity=4, avail=8, cyberlimbs=True, subtype='Earware')
DAMPER = Augmentation("DAMPER", page_ref=454, cost=2250, essence=0.1, capacity=1, avail=6, cyberlimbs=True, subtype='Earware')
SELECT_SOUND_FILTER_AUG_1_6 = Augmentation("SELECT_SOUND_FILTER_AUG_1_6", page_ref=454, cost=["Rating", "*", 3500], rating=[1, "to", 6], essence=0.1, capacity=["Rating"], avail=[["Rating", "*", 3]], cyberlimbs=True, subtype='Earware')
SOUND_LINK = Augmentation("SOUND_LINK", page_ref=454, cost=1000, essence=0.1, capacity="-", avail=4, cyberlimbs=False, as_standard=True, subtype='Earware')
SPATIAL_RECOGNIZER = Augmentation("SPATIAL_RECOGNIZER", page_ref=454, cost=4000, essence=0.1, capacity=2, avail=8, cyberlimbs=True, subtype='Earware')
# BODYWARE
BONE_LACING_PLASTIC = Augmentation("BONE_LACING_PLASTIC", page_ref=456, cost=8000, essence=0.5, capacity="-", avail=[8, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
BONE_LACING_ALUMINUM = Augmentation("BONE_LACING_ALUMINUM", page_ref=456, cost=18000, essence=1, capacity="-", avail=[12, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
BONE_LACING_TITANIUM = Augmentation("BONE_LACING_TITANIUM", page_ref=456, cost=30000, essence=1.5, capacity="-", avail=[16, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
DERMAL_PLANTING_1_6 = Augmentation("DERMAL_PLANTING_1_6", page_ref=456, cost=["Rating", "*", 3000], rating=[1, "to", 6], essence=["Rating", "*", 0.5], capacity="-", avail=[["Rating", "*", 4], RESTRICTED], cyberlimbs=False, subtype='Bodyware')
FINGERTIP_COMPARTMENT = Augmentation("FINGERTIP_COMPARTMENT", page_ref=456, cost=3000, essence=0.1, capacity=1, avail=4, cyberlimbs=True, subtype='Bodyware')
GRAPPLE_GUN_AUG = Augmentation("GRAPPLE_GUN_AUG", page_ref=456, cost=5000, essence=0.5, capacity=4, avail=8, cyberlimbs=True, subtype='Bodyware')
INTERNAL_AIR_TANK_1_3 = Augmentation("INTERNAL_AIR_TANK_1_3", page_ref=456, cost=["Rating", "*", 8000], rating=[1, "to", 3], essence=0.25, capacity=3, avail=[["Rating"]], cyberlimbs=True, subtype='Bodyware')
MUSCLE_REPLACEMENT_1_3 = Augmentation("MUSCLE_REPLACEMENT_1_3", page_ref=456, cost=["Rating", "*", 25000], rating=[1, "to", 4], essence=["Rating", "*", 1], capacity="-", avail=[["Rating", "*", 5], RESTRICTED], cyberlimbs=False, subtype='Bodyware')
REACTION_ENHANCERS_1_3 = Augmentation("REACTION_ENHANCERS_1_3", page_ref=456, cost=["Rating", "*", 13000], rating=[1, "to", 3], essence=["Rating", "*", 0.3], capacity="-", avail=[["Rating", "*", 5], RESTRICTED], cyberlimbs=False, subtype='Bodyware')
SKILLWIRES_1_6 = Augmentation("SKILLWIRES_1_6", page_ref=456, cost=["Rating", "*", 20000], rating=[1, "to", 6], essence=["Rating", "*", 0.1], capacity="-", avail=[["Rating", "*", 4]], cyberlimbs=False, subtype='Bodyware')
SMUGGLING_COMPARTMENT = Augmentation("SMUGGLING_COMPARTMENT", page_ref=456, cost=7500, essence=0.2, capacity=2, avail=6, cyberlimbs=True, subtype='Bodyware')
WIRED_REFLEXES_1 = Augmentation("WIRED_REFLEXES_1", page_ref=456, cost=39000, essence=2, capacity="-", avail=[8, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
WIRED_REFLEXES_2 = Augmentation("WIRED_REFLEXES_2", page_ref=456, cost=149000, essence=3, capacity="-", avail=[12, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
WIRED_REFLEXES_3 = Augmentation("WIRED_REFLEXES_3", page_ref=456, cost=217000, essence=5, capacity="-", avail=[20, RESTRICTED], cyberlimbs=False, subtype='Bodyware')
# CYBERLIMBS
FULL_ARM_OBV = Augmentation("FULL_ARM_OBV", page_ref=457, cost=15000, essence=1, capacity=15, avail=4, subtype='Cyberlimbs Obvious')
FULL_LEG_OBV = Augmentation("FULL_LEG_OBV", page_ref=457, cost=15000, essence=1, capacity=20, avail=4, subtype='Cyberlimbs Obvious')
HAND_OBV = Augmentation("HAND_OBV", page_ref=457, cost=5000, essence=0.25, capacity=4, avail=2, subtype='Cyberlimbs Obvious')
FOOT_OBV = Augmentation("FOOT_OBV", page_ref=457, cost=5000, essence=0.25, capacity=4, avail=2, subtype='Cyberlimbs Obvious')
LOWER_ARM_OBV = Augmentation("LOWER_ARM_OBV", page_ref=457, cost=10000, essence=0.45, capacity=10, avail=4, subtype='Cyberlimbs Obvious')
LOWER_LEG_OBV = Augmentation("LOWER_LEG_OBV", page_ref=457, cost=10000, essence=0.45, capacity=12, avail=4, subtype='Cyberlimbs Obvious')
TORSO_OBV = Augmentation("TORSO_OBV", page_ref=457, cost=20000, essence=1.5, capacity=10, avail=12, subtype='Cyberlimbs Obvious')
SKULL_OBV = Augmentation("SKULL_OBV", page_ref=457, cost=10000, essence=0.75, capacity=4, avail=16, subtype='Cyberlimbs Obvious')
FULL_ARM_SYNTH = Augmentation("FULL_ARM_SYNTH", page_ref=457, cost=20000, essence=1, capacity=8, avail=4, subtype='Cyberlimbs Synthetic')
FULL_LEG_SYNTH = Augmentation("FULL_LEG_SYNTH", page_ref=457, cost=20000, essence=1, capacity=10, avail=4, subtype='Cyberlimbs Synthetic')
HAND_SYNTH = Augmentation("HAND_SYNTH", page_ref=457, cost=6000, essence=0.25, capacity=2, avail=2, subtype='Cyberlimbs Synthetic')
FOOT_SYNTH = Augmentation("FOOT_SYNTH", page_ref=457, cost=6000, essence=0.25, capacity=2, avail=2, subtype='Cyberlimbs Synthetic')
LOWER_ARM_SYNTH = Augmentation("LOWER_ARM_SYNTH", page_ref=457, cost=12000, essence=0.45, capacity=5, avail=4, subtype='Cyberlimbs Synthetic')
LOWER_LEG_SYNTH = Augmentation("LOWER_LEG_SYNTH", page_ref=457, cost=12000, essence=0.45, capacity=6, avail=4, subtype='Cyberlimbs Synthetic')
TORSO_SYNTH = Augmentation("TORSO_SYNTH", page_ref=457, cost=25000, essence=1.5, capacity=5, avail=12, subtype='Cyberlimbs Synthetic')
SKULL_SYNTH = Augmentation("SKULL_SYNTH", page_ref=457, cost=15000, essence=0.75, capacity=2, avail=16, subtype='Cyberlimbs Synthetic')
# CYBERLIMB ENHANCEMENTS
CYBERLIMB_EN_AGILITY = Augmentation("CYBERLIMB_EN_AGILITY", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=[["Rating", "*", 3], RESTRICTED], subtype='Cyberlimbs Enhancement')
CYBERLIMB_EN_ARMOR = Augmentation("CYBERLIMB_EN_ARMOR", page_ref=457, cost=["Rating", "*", 3000], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=[["Rating", "*", 5]], subtype='Cyberlimbs Enhancement')
CYBERLIMB_EN_STRENGTH = Augmentation("CYBERLIMB_EN_STRENGTH", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=[["Rating", "*", 3], RESTRICTED], subtype='Cyberlimbs Enhancement')
# CYBERLIMB ACCESSORIES
CYBERARM_GYROMOUNT = Augmentation("CYBERARM_GYROMOUNT", page_ref=457, cost=6000, essence="-", capacity=8, avail=[12, FORBIDDEN], cymberlimbs=True, subtype='Cyberlimb Accessory')
CYBERARM_SLIDE = Augmentation("CYBERARM_SLIDE", page_ref=457, cost=3000, essence="-", capacity=3, avail=[12, RESTRICTED], cymberlimbs=True, subtype='Cyberlimb Accessory')
CYBER_HOLSTER = Augmentation("CYBER_HOLSTER", page_ref=457, cost=2000, essence="-", capacity=5, avail=[8, RESTRICTED], cymberlimbs=True, subtype='Cyberlimb Accessory')
HYDRAULIC_JACKS_1_6 = Augmentation("HYDRAULIC_JACKS_1_6", page_ref=457, cost=["Rating", "*", 2500], rating=[1, "to", 6], essence="-", capacity=["Rating"], avail=9, cymberlimbs=True, subtype='Cyberlimb Accessory')
LARGE_SMUGGLING_COMPARMENT = Augmentation("LARGE_SMUGGLING_COMPARMENT", page_ref=457, cost=8000, essence="-", capacity=5, avail=6, cymberlimbs=True, subtype='Cyberlimb Accessory')
# CYBER IMPLANT WEAPONS - AUGMENTATION ENTRY
CYBER_HOLD_OUT_PISTOL = Augmentation("CYBER_HOLD_OUT_PISTOL", page_ref=458, cost=2000, essence=0.1, capacity=2, avail=[8, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_LIGHT_PISTOL = Augmentation("CYBER_LIGHT_PISTOL", page_ref=458, cost=3900, essence=0.25, capacity=4, avail=[10, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_MACHINE_PISTOL = Augmentation("CYBER_MACHINE_PISTOL", page_ref=458, cost=3500, essence=0.5, capacity=6, avail=[12, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HEAVY_PISTOL = Augmentation("CYBER_HEAVY_PISTOL", page_ref=458, cost=4300, essence=0.5, capacity=6, avail=[12, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SUBMACHINE_GUN = Augmentation("CYBER_SUBMACHINE_GUN", page_ref=458, cost=4800, essence=1, capacity=8, avail=[12, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SHOTGUN = Augmentation("CYBER_SHOTGUN", page_ref=458, cost=8500, essence=1.25, capacity=10, avail=[12, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_MICROGRENADE_LAUNCHER = Augmentation("CYBER_MICROGRENADE_LAUNCHER", page_ref=458, cost=30000, essence=1.5, capacity=15, avail=[20, FORBIDDEN], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HAND_BLADE = Augmentation("CYBER_HAND_BLADE", page_ref=458, cost=2500, essence=0.25, capacity=2, avail=[10, FORBIDDEN], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HAND_RAZOR = Augmentation("CYBER_HAND_RAZOR", page_ref=458, cost=1250, essence=0.2, capacity=2, avail=[8, FORBIDDEN], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SPURS = Augmentation("CYBER_SPURS", page_ref=458, cost=5000, essence=0.3, capacity=3, avail=[12, FORBIDDEN], cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SHOCK_HAND = Augmentation("CYBER_SHOCK_HAND", page_ref=458, cost=5000, essence=0.25, capacity=4, avail=[8, RESTRICTED], cyberlimbs=True, subtype="Cyber Implant Weapons")
...
# BIOWARE
ADRENALINE_PUMP_1_3 = Augmentation("ADRENALINE_PUMP_1_3", page_ref=460, cost=["Rating", "*", 55000], rating=[1, "to", 3], essence=["Rating", "*", 0.75], avail=[["Rating", "*", 6], FORBIDDEN], subtype="Bioware")
...
MUSCLE_AUGMENTATION_1_4 = Augmentation("MUSCLE_AUGMENTATION_1_4", page_ref=460, cost=["Rating", "*", 31000], rating=[1, "to", 4], essence=["Rating", "*", 0.2], avail=[["Rating", "*", 5], RESTRICTED], subtype="Bioware")
MUSCLE_TONER_1_4 = Augmentation("MUSCLE_TONER_1_4", page_ref=460, cost=["Rating", "*", 32000], rating=[1, "to", 4], essence=["Rating", "*", 0.2], avail=[["Rating", "*", 5], RESTRICTED], subtype="Bioware")
ORTHOSKIN_1_4 = Augmentation("ORTHOSKIN_1_4", page_ref=460, cost=["Rating", "*", 6000], rating=[1, "to", 4], essence=["Rating", "*", 0.25], avail=[["Rating", "*", 5], RESTRICTED], subtype="Bioware")
...
SUPRATHYROID_GLAND = Augmentation("SUPRATHYROID_GLAND", page_ref=460, cost=140_000, essence=0.7, avail=[20, RESTRICTED], subtype="Bioware")
...
TAILORED_PHEROMONES_1_3 = Augmentation("TAILORED_PHEROMONES_1_3", page_ref=460, cost=["Rating", "*", 31000], rating=[1, "to", 3], essence=["Rating", "*", 0.2], avail=[["Rating", "*", 4], RESTRICTED], subtype="Bioware")
...
DAMAGE_COMPENSATORS_1_12 = Augmentation("DAMAGE_COMPENSATORS_1_12", page_ref=461, cost=["Rating", "*", 2000], rating=[1, "to", 12], essence=["Rating", "*", 0.1], avail=[["Rating", "*", 3], FORBIDDEN], subtype="Cultured Bioware")
...
PAIN_EDITOR = Augmentation("PAIN_EDITOR", page_ref=461, cost=48000, essence=0.3, avail=[18, FORBIDDEN], subtype="Cultured Bioware")
...
SYNAPTIC_BOOSTER_1_3 = Augmentation("SYNAPTIC_BOOSTER_1_3", page_ref=461, cost=["Rating", "*", 95000], rating=[1, "to", 3], essence=["Rating", "*", 0.5], avail=[["Rating", "*", 6], RESTRICTED], subtype="Cultured Bioware")
"""
    PRIORITY TABLE
"""
PRIORITY_TABLE = { 
