...
"""
# HEADWARE
COMMLINK = Augmentation("COMMLINK", page_ref=453, cost=["Commlink Cost", "+", 2000], essence=0.2, capacity=2, avail=0, cyberlimbs=True, subtype="Headware")
CONTROL_RIG_1 = Augmentation("CONTROL_RIG_1", page_ref=453, cost=43_000, rating=1, essence=1, capacity="-", avail=5, legality=RESTRICTED, subtype="Headware")
CONTROL_RIG_2 = Augmentation("CONTROL_RIG_2", page_ref=453, cost=97_000, rating=2, essence=2, capacity="-", avail=10, legality=RESTRICTED, subtype="Headware")
CONTROL_RIG_3 = Augmentation("CONTROL_RIG_3", page_ref=453, cost=208_000, rating=3, essence=3, capacity="-", avail=15, legality=RESTRICTED, subtype="Headware")
CORTEX_BOMB_KINK = Augmentation("CORTEX_BOMB_KINK", page_ref=453, cost=10_000, essence=0, capacity=1, avail=12, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware")
CORTEX_BOMB_MICROBOMB = Augmentation("CORTEX_BOMB_MICROBOMB", page_ref=453, cost=25_000, essence=0, capacity=2, avail=16, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware")
CORTEX_BOMB_AREA = Augmentation("CORTEX_BOMB_AREA", page_ref=453, cost=40_000, essence=0, capacity=3, avail=20, legality=FORBIDDEN, cyberlimbs=True, subtype="Headware")
CYBERDECK = Augmentation("CYBERDECK", page_ref=453, cost=["Deck Cost", "+", 5000], essence=0.4, capacity=4, avail=5, legality=RESTRICTED, cyberlimbs=True, subtype="Headware")
...
VOICE_MODULATOR_1_6 = Augmentation("VOICE_MODULATOR_1_6", page_ref=453, cost=["Rating", "*", 5000], rating=[1, "to", 6], essence=0.2, capacity="-", avail=["Rating", "*", 3], legality=FORBIDDEN, subtype="Headware")
# EYEWARE
...
RETINAL_DUPLICATION_1_6 = Augmentation("RETINAL_DUPLICATION_1_6", page_ref=454, cost=["Rating", "*", 20_000], rating=[1, "to", 6], essence=0.1, capacity=1, avail=16, legality=FORBIDDEN, cyberlimbs=True, subtype='Eyeware')
SMARTLINK_AUG = Augmentation("SMARTLINK_AUG", page_ref=454, cost=4000, essence=0.2, capacity=3, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype='Eyeware')
...
# BODYWARE
BONE_LACING_PLASTIC = Augmentation("BONE_LACING_PLASTIC", page_ref=456, cost=8000, essence=0.5, capacity="-", avail=8, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
BONE_LACING_ALUMINUM = Augmentation("BONE_LACING_ALUMINUM", page_ref=456, cost=18000, essence=1, capacity="-", avail=12, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
BONE_LACING_TITANIUM = Augmentation("BONE_LACING_TITANIUM", page_ref=456, cost=30000, essence=1.5, capacity="-", avail=16, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
DERMAL_PLANTING_1_6 = Augmentation("DERMAL_PLANTING_1_6", page_ref=456, cost=["Rating", "*", 3000], rating=[1, "to", 6], essence=["Rating", "*", 0.5], capacity="-", avail=["Rating", "*", 4], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
...
MUSCLE_REPLACEMENT_1_3 = Augmentation("MUSCLE_REPLACEMENT_1_3", page_ref=456, cost=["Rating", "*", 25000], rating=[1, "to", 4], essence=["Rating", "*", 1], capacity="-", avail=["Rating", "*", 5], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
REACTION_ENHANCERS_1_3 = Augmentation("REACTION_ENHANCERS_1_3", page_ref=456, cost=["Rating", "*", 13000], rating=[1, "to", 3], essence=["Rating", "*", 0.3], capacity="-", avail=["Rating", "*", 5], legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
...
WIRED_REFLEXES_1 = Augmentation("WIRED_REFLEXES_1", page_ref=456, cost=39000, essence=2, capacity="-", avail=8, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
WIRED_REFLEXES_2 = Augmentation("WIRED_REFLEXES_2", page_ref=456, cost=149000, essence=3, capacity="-", avail=12, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
WIRED_REFLEXES_3 = Augmentation("WIRED_REFLEXES_3", page_ref=456, cost=217000, essence=5, capacity="-", avail=20, legality=RESTRICTED, cyberlimbs=False, subtype='Bodyware')
# CYBERLIMBS
...
CYBERLIMB_EN_AGILITY = Augmentation("CYBERLIMB_EN_AGILITY", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=["Rating", "*", 3], legality=RESTRICTED, subtype='Cyberlimbs Enhancement')
...
CYBERLIMB_EN_STRENGTH = Augmentation("CYBERLIMB_EN_STRENGTH", page_ref=457, cost=["Rating", "*", 6500], rating=[1, "to", 3], essence="-", capacity=["Rating"], avail=["Rating", "*", 3], legality=RESTRICTED, subtype='Cyberlimbs Enhancement')
# CYBERLIMB ACCESSORIES
CYBERARM_GYROMOUNT = Augmentation("CYBERARM_GYROMOUNT", page_ref=457, cost=6000, essence="-", capacity=8, avail=12, legality=FORBIDDEN, cymberlimbs=True, subtype='Cyberlimb Accessory')
CYBERARM_SLIDE = Augmentation("CYBERARM_SLIDE", page_ref=457, cost=3000, essence="-", capacity=3, avail=12, legality=RESTRICTED, cymberlimbs=True, subtype='Cyberlimb Accessory')
CYBER_HOLSTER = Augmentation("CYBER_HOLSTER", page_ref=457, cost=2000, essence="-", capacity=5, avail=8, legality=RESTRICTED, cymberlimbs=True, subtype='Cyberlimb Accessory')
...
CYBER_HOLD_OUT_PISTOL = Augmentation("CYBER_HOLD_OUT_PISTOL", page_ref=458, cost=2000, essence=0.1, capacity=2, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_LIGHT_PISTOL = Augmentation("CYBER_LIGHT_PISTOL", page_ref=458, cost=3900, essence=0.25, capacity=4, avail=10, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_MACHINE_PISTOL = Augmentation("CYBER_MACHINE_PISTOL", page_ref=458, cost=3500, essence=0.5, capacity=6, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HEAVY_PISTOL = Augmentation("CYBER_HEAVY_PISTOL", page_ref=458, cost=4300, essence=0.5, capacity=6, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SUBMACHINE_GUN = Augmentation("CYBER_SUBMACHINE_GUN", page_ref=458, cost=4800, essence=1, capacity=8, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SHOTGUN = Augmentation("CYBER_SHOTGUN", page_ref=458, cost=8500, essence=1.25, capacity=10, avail=12, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_MICROGRENADE_LAUNCHER = Augmentation("CYBER_MICROGRENADE_LAUNCHER", page_ref=458, cost=30000, essence=1.5, capacity=15, avail=20, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HAND_BLADE = Augmentation("CYBER_HAND_BLADE", page_ref=458, cost=2500, essence=0.25, capacity=2, avail=10, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_HAND_RAZOR = Augmentation("CYBER_HAND_RAZOR", page_ref=458, cost=1250, essence=0.2, capacity=2, avail=8, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SPURS = Augmentation("CYBER_SPURS", page_ref=458, cost=5000, essence=0.3, capacity=3, avail=12, legality=FORBIDDEN, cyberlimbs=True, subtype="Cyber Implant Weapons")
CYBER_SHOCK_HAND = Augmentation("CYBER_SHOCK_HAND", page_ref=458, cost=5000, essence=0.25, capacity=4, avail=8, legality=RESTRICTED, cyberlimbs=True, subtype="Cyber Implant Weapons")
