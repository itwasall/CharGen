...
# FULL_BODY_ARMOR_CHEMICAL_SEAL = ArmorModification("Chemical Seal", cost=6000, page_ref=436, avail=[FULL_BODY_ARMOR.avail[0] +6, legality=RESTRICTED, requires=FULL_BODY_ARMOR, armor_rating=1)
# FULL_BODY_ARMOR_ENVIRONMENTAL_ADAPTATION = ArmorModification("Environmental Adaptation", 1000, page_ref=436, avail=[FULL_BODY_ARMOR.avail[0] +3, legality=RESTRICTED, requires=FULL_BODY_ARMOR, armor_rating=1)
