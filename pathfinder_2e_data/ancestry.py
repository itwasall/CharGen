...
class Heritage:
    ...
    def __repr__(self):
        return f"{self.race} - {self.name[:-5]}"

[Dwarf_AncientBlooded,
 Dwarf_DeathWarden,
 Dwarf_Forge,
 Dwarf_Rock,
 Dwarf_StrongBlooded
        ...
        i,
        'Dwarf',
        data_ancestry['Dwarf']['heritages'][i]['desc'],
        data_ancestry['Dwarf']['heritages'][i]['effects']
        ) 
      for i in data_ancestry['Dwarf']['heritages'].keys()]

DWARF_HERITAGES = [Dwarf_AncientBlooded, Dwarf_DeathWarden, Dwarf_Forge, Dwarf_Rock, Dwarf_StrongBlooded]
print([i for i in DWARF_HERITAGES])
